// !preview r2d3 data=dat, dependencies=c("js/yaxis.js", "js/legend.js", "js/lines_dt.js", "js/lines.js", "js/xaxis_char.js"), options=list(yfmt = ".0%")
//
//
...
r2d3.onRender(function(data, svg, width, height, options){
  ...
  let xx = new x_axis_lines_char(data, {top: ll.lheight, right: 0, bottom: 0, left:yax.lbwidth}, width, height, {bar:false})
  ...
  let ll = new legend(data, {top: 0, right: 0, bottom: xx.height, left:yax.lbwidth}, width, height, high, yax.yScale)
