// !preview r2d3 data=dat, dependencies=c("js/yaxis.js", "js/labels.js", "js/lines_dt.js", "js/lines.js", "js/xaxis_char.js"), options=list(yfmt = ".0%", high = TRUE)
//
//
...
r2d3.onRender(function(data, svg, width, height, options){
  ...
  let ll = new legend_labels(data, 0, 0, 0, 0, width, height, options.high, yax.yScale)
  ...
  ll = new legend_labels(data, 0, ll.lbwidth, xx.height, 0, width, height, options.high, yax.yScale, xx.xScale)
...
r2d3.onResize(function(width, height){
  ...
  let ll = new legend_labels(dd1, 0, 0, 0, 0, width, height, options.high, yax.yScale)
  ...
  ll = new legend_labels(dd1, 0, ll.lbwidth, xx.height, 0, width, height, options.high, yax.yScale, xx.xScale)
